...
DATA_PATH = 'datasets/dancetrackT'
...
if __name__ == '__main__':
    ...
    for split in SPLITS:
        ...
        data_path = os.path.join(DATA_PATH, split)  # datasets/dancetrack/train
        ...
        seqs = os.listdir(data_path)  # [dancetrack0001, ...]
        image_cnt = 0
        ann_cnt = 0
        video_cnt = 0
        for seq in sorted(seqs):
            ...
            seq_path = os.path.join(data_path, seq)  # datasets/dancetrack/train/dancetrack0001
