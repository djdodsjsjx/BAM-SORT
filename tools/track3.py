...
from trackers.integrated_ocsort_embedding import ocsort
...
def imageflow_demo(predictor, vis_folder, current_time, args):
    ...
    tracker = ocsort.OCSort(**oc_sort_args)
    ...
    for color_frame in color_image:
        ...
        if outputs[0] is not None:
            timer_track.tic()
            online_targets = tracker.update(outputs[0], img_info, args.test_size, frame_id)
            online_tlwhs = []
            online_ids = []
